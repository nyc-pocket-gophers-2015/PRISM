...
file = ARGV.empty? ? 'flashcard_samples.txt' : ARGV[0] 
...
# defensive programming is good (raising exceptions) but be specific
# the best place for it is also usually around where the user interfaces
# with your program, assume your users are dumb
